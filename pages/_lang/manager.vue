        ...
        <div class="row">
            ...
            <div class="iconbox center circle large">
              ...
              <div class="box-content">
                <ul class="flat-list style2">
                  ...
                  <li>{{ $t('features.manager.box4.list.list3') }}</li>
                  <li>{{ $t('features.manager.box4.list.list4') }}</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <!-- <div class="col-md-3">
            <div class="iconbox center circle large">
              ...
              <div class="box-content">
                <ul class="flat-list style2">
                  <li>{{ $t('features.manager.box5.list.list1') }}</li>
                  <li>{{ $t('features.manager.box5.list.list2') }}</li>
                  <li>{{ $t('features.manager.box5.list.list3') }}</li>
                </ul>
              </div>
            </div>
          </div> -->
...
export default {
  ...
  data() {
    return {
      metaTitle: this.$t('links.manager'),
